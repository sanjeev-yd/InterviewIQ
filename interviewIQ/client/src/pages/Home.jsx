        ...
        <div className='flex justify-center mb-6'>
          ...
          <div className='text-center mb-28'>
            ...
            <span className='relative inline-block'>
              <span className='bg-green-100 text-green-600 px-5 py-1 rounded-fulll'>
               AI Intelligence
              </span>
            </span>
            </motion.h1>
            ...
            className='text-gray-500 mt-6 max-auto text-lg'>
             Role-based mock interviews with smart follow-ups,adaptive difficulty and real-time <br></br>performance evaluation.
            </motion.p>
             ...
             <div className='flex flex-wrap justify-center gap-4 mt-10'>
              ...
              whileTap={{opacity:1,scale:0.98}} className='bg-black text-white px-10 py-3 rounded-full hover:opacity-90 transition shadow-md'>
               Start Interview
              ...
              whileHover={{opacity:0.9, scale:1.03}}
              whileTap={{opacity:1,scale:0.98}} className='border border-gray-300 px-10 py-3 rounded-full hover:bg-gray-100 transition'>
               View History
              </motion.button>
             </div>
          </div>
            ...
            [
              {
                ...
                desc: "Scores communication, technical acuuracy and confidence."
              },
              {
                image:resumeImg,
