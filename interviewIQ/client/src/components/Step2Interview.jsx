...
function Step2Interview({interviewData, onFinsih}) {
  ...
  return (
    <div className='min-h-screen bg-linear-to-br from-emerald-50 via-white to-tesl-100 flex items-center justify-center p-4 sm:p-6'>
